...
You can purchase premium version here [Online Product Designer Plugin for Woocommerce WordPress](http://cmsmart.net/wordpress-plugins/woocommerce-online-product-designer-plugin). 
Admin demo: <a href="https://cmsmart.net/wordpress-plugins/woocommerce-online-product-designer-plugin#backend-demo">https://cmsmart.net/wordpress-plugins/woocommerce-online-product-designer-plugin#backend-demo</a>
...
1. Design interface
2. Detail order design
3. Clip-art management
4. Font setting
5. Box Order design

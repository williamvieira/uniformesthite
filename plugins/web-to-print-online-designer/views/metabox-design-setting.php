                    ...
                    <div class="nbdesigner-box-container">
                        ...
                        <div class="nbdesigner-box nbdesigner-box-collapse" data-variation="com">
                            ...
                            <div class="nbdesigner-info-box">                             
                                ...
                                <!-- Adição de Cores Multlinks --> 
                                <p class="nbd-setting-section-title">
                                    <?php echo __('Select Pruduct Color', 'web-to-print-online-designer'); ?>&nbsp;
                                </p>
                                <div class="nbdesigner-info-box-inner">
                                    <label class="nbdesigner-setting-box-label"><?php echo __('Colors', 'web-to-print-online-designer'); ?></label>
                                    <div>
                                        <label>
                                            <input type="checkbox" class="select-all" name="_designer_setting[<?php echo $k ?>][area_design_ml_color_all]" data-index="ml-color-all" <?php echo ($v['area_design_ml_color_all']) ? 'checked': '';?>> Selecionar todos &nbsp; 
                                            </label>
                                        <?php $hex_names = explode( ',', get_option( 'nbdesigner_hex_names' ) ); ?>
                                        <?php foreach( $hex_names as $colors ): ?>
                                        <?php $color = explode( ':', $colors );?>
                                        <label>
                                            <input type="checkbox"  name="_designer_setting[<?php echo $k; ?>][area_design_ml_color][]" 
                                                   value="<?php echo $color[0]; ?>" class="short area_design_dimension area_design_width area_design_ml_color" data-index="ml-color" <?php echo ( $v['area_design_ml_color'] && in_array( $color[0], $v['area_design_ml_color'] ) ) ? 'checked' : '' ?>><?php echo $color[1];?> &nbsp;
                                            </label>
                                            <?php endforeach;?>
                                    </div>
                                </div>
                                <!-- FIM Adição de Cores Multlinks -->
                            </div>	
                        </div>
                    </div>

...
<div class="nbdesigner-setting-variation">
    <h3><?php __('Setting Design', 'web-to-print-online-designer'); ?></h3>
    <div class="nbdesigner-left">
        <input type="hidden" value="0" name="_nbdesigner_enable<?php echo $vid; ?>"/>
        <label for="_nbdesigner_enable<?php echo $vid; ?>" class="nbdesigner-setting-box-label"><?php echo _e('Enable Design for this variation', 'web-to-print-online-designer'); ?></label>
    ...
    <div class="nbdesigner-right add_more" style="<?php if(!$enable) echo 'display: none;'; ?>">
        <a class="button button-primary" onclick="NBDESIGNADMIN.addOrientation(<?php echo $vid; ?>)"><?php echo __('Add More', 'web-to-print-online-designer'); ?></a>
            ...
            <div class="nbdesigner-box-container">
                <div class="nbdesigner-box">
                    ...
                    <div class="nbdesigner-right">
                        <a class="button nbdesigner-collapse" onclick="NBDESIGNADMIN.collapseBox(this)"><span class="dashicons dashicons-arrow-down"></span><?php _e('More setting', 'web-to-print-online-designer'); ?></a>
                ...
                <div class="nbdesigner-box nbdesigner-box-collapse" data-variation="<?php echo $vid; ?>" style="display: none;">
                    ...
                    <div class="nbdesigner-info-box">
                        <p class="nbd-setting-section-title"><?php echo __('Product size:', 'web-to-print-online-designer'); ?></p>
                        ...
                        <p class="nbd-setting-section-title"><?php echo __('Design area size:', 'web-to-print-online-designer'); ?></p>
                        <div class="nbdesigner-info-box-inner notice-width nbd-has-notice">
                            <label class="nbdesigner-setting-box-label"><?php echo __('Width', 'web-to-print-online-designer'); ?></label>
                            <div>

			...
			<div class="nbdesigner-content-left postbox">
				<div class="inside">	
					...
					<table class="form-table">
						<tr valign="top">
							<th scope="row" class="titledesc"><?php echo __("Clipart name", 'web-to-print-online-designer'); ?> </th>
		...
		<div class="nbdesigner-list-fonts inside">				
                    <div class="nbdesigner-list-arts-container">
                            <?php if(is_array($_list) && (sizeof($_list) > 0)): ?>
                                    ...
                                    ?>
                        <span class="nbdesigner_art_link "><span><?php echo $val->title; ?></span><img src="<?php echo $art_url; ?>" /><span class="nbdesigner_action_delete_art" data-index="<?php echo $val->id; ?>" onclick="NBDESIGNADMIN.delete_art(this)">&times;</span></span>

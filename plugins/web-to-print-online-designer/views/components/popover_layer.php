...
<div class=" shadow popup" id="container_layer">
    ...
    <div id="dg-layers" class="has-croll">
        <ul id="layers">
            <li class="layer" id="layer-{{layer.index}}" ng-repeat="layer in currentLayers| reverse" ng-class="{active: currentLayerActive === layer.index, 'lock' : layer.class === 'lock', 'static': layer.isBg}" ng-click="activeLayer(layer)">

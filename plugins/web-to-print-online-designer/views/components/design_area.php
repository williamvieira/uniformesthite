...
<a ng-hide="settings['ui_mode'] == 1" href="<?php bloginfo('url'); ?>" class="shadow hover-shadow back-to-main-site nbd-tooltip-i18n"  data-placement="right" data-lang="RETURN_TO_SHOP"><i class="fa fa-home"></i></a>

...
<div id="config_art" class="shadow od_tab nbdesigner_config" ng-style="{'display': pop.clipArt}">
    <ul class="config_list" id="art_config_list">
        <li ng-show="settings['nbdesigner_clipart_change_path_color'] == 1">
            <a ng-click="showPathConfig()" ng-show="settings['nbdesigner_clipart_change_path_color'] == 1" data-target="#dg-config-art" data-toggle="modal">
                <span class="fa fa-tint" aria-hidden="true"></span>
            </a>
        </li>
        <li>
            <a href="#svg_config"><span class="fa fa-cog" aria-hidden="true"></span></a>
        </li>
    </ul>
    ...
    <div id="svg_path" class="nbdesigner_config_content content" ng-show="settings['nbdesigner_clipart_change_path_color'] == 1">
        <span class="text-item" ng-click="showPathConfig()" data-target="#dg-config-art" data-toggle="modal">{{(langs['MANAGER_PATH']) ? langs['MANAGER_PATH'] : "Manager Path"}}</span>
    </div>

...
<div class="nbdesigner_frontend_container">
    <p>
        <a class="button alt nbdesign-button nbdesigner-disable <?php echo $class; ?>" id="triggerDesign" >
            ...
            <?php _e('Personalizar', 'web-to-print-online-designer'); ?>
        </a>
    </p>   
    <h4 id="nbdesigner-preview-title" style="display: none;"><?php _e('Design personalizado', 'web-to-print-online-designer'); ?></h4>

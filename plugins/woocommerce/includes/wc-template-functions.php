...
if ( ! function_exists( 'woocommerce_widget_shopping_cart_button_view_cart' ) ) {
	...
	function woocommerce_widget_shopping_cart_button_view_cart() {
		echo '<a href="' . esc_url( wc_get_cart_url() ) . '" class="button wc-forward">' . esc_html__( 'Ver orçamento', 'woocommerce' ) . '</a>';
	}
}
...
function wc_empty_cart_message() {
	echo '<p class="cart-empty">' . wp_kses_post( apply_filters( 'wc_empty_cart_message', __( 'Seu orçamento está vazio.', 'woocommerce' ) ) ) . '</p>';
}
